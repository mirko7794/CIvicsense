	  ...
	  <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form enctype="multipart/form-data" data-toggle="validator" role="form" method="POST" action="Segnalazioni.php">
			   ...
			   <div class="form-group">
                 <div class="col-sm-4 col-lg-3">
                   <button onclick="location.href='Segnalazioni.php'" type="button" class="btn btn-danger btn-block">Annulla</button>
                 </div>
               </div>
              </form>
			</div>
        ...
        <div class="row h-100">
          <div class="col-lg-7 my-auto">
            <div class="header-content mx-auto">
			  ...
			  <form method = "post" action = "Segnalazioni.php">
                <div font face="Arial, Helvetica, sans-serif"><p><strong>Inserire il codice di tracciamento della segnalazione che si intende ricercare, modificare o eliminare: </strong></p>  
				...
				<form method = 'POST' action = 'Segnalazioni.php'>
			     ...
			     <?php
			        ...
			        if(isset($_POST["cdt"]) != NULL) {
						...
						$query1 = "SELECT * FROM ticket WHERE CodicediTracciamento = $cdt";
				 ...
				 ?>
				 <!-- script ajax per eliminare la segnalazione-->
				         <script type="text/javascript">
						  
						  function cancella() {
							  var ok = window.confirm("Confermi di voler eliminare la segnalazione selezionata ?");
							  if(ok) {
								  callWebService();
								  } else {
								  return annulla;
							...
							function callWebService() {
								  var requestURL = "CancellaSegnalazione.php";
								  try {
				 ...
				 <?php 
				        // bottoni per modifica e cancella segnalazione
				          print_r("<a href = 'http://localhost/bootstrap/my_civic_sense/ModificaSegnalazione.php'>");
									...
									if($visual == "Tutte") { //se selezionate tutte le visualizzazioni
											...
											$result = mysqli_query($mysqli, $query);
												if($row = mysqli_fetch_row($result)) {
													echo "<strong>ELENCO COMPLETO SEGNALAZIONI</strong>";
													echo "<table align='center' bgcolor='#FFFFFF' border=\"2\" cellspacing=\"1\" cellpadding=\"1\">";
													echo "<tr>";
													echo "<th><font face=\"Arial, Helvetica, sans-serif\">Codice di tracciamento</font></th>";
	                                                echo "<th><font face=\"Arial, Helvetica, sans-serif\">Latitudine</font></th>";
											...
											$query1 = "SELECT * FROM `ticket` WHERE Stato = 'Attiva' ";
											...
											$result1 = mysqli_query($mysqli, $query1);
												if($row1 = mysqli_fetch_row($result1)) {
													echo "<strong>ELENCO SEGNALAZIONI ATTIVE</strong>";
													echo "<table align='center' bgcolor='#FFFFFF' border=\"2\" cellspacing=\"1\" cellpadding=\"1\">";
													echo "<tr>";
													echo "<th><font face=\"Arial, Helvetica, sans-serif\">Codice di tracciamento</font></th>";
	                                                echo "<th><font face=\"Arial, Helvetica, sans-serif\">Latitudine</font></th>";
											...
											$query2 = "SELECT * FROM `ticket` WHERE Stato = 'Conclusa' ";
											...
											$result2 = mysqli_query($mysqli, $query2);
												if($row2 = mysqli_fetch_row($result2)) {
													echo "<strong>ELENCO SEGNALAZIONI CONCLUSE</strong>";
													echo "<table align='center' bgcolor='#FFFFFF' border=\"2\" cellspacing=\"1\" cellpadding=\"1\">";
													echo "<tr>";
													echo "<th><font face=\"Arial, Helvetica, sans-serif\">Codice di tracciamento</font></th>";
	                                                echo "<th><font face=\"Arial, Helvetica, sans-serif\">Latitudine</font></th>";
...
if(isset($_POST['ticket'])){
  ...
  if ($conn->query($sql) === TRUE) {
	...
	print_r("<meta http-equiv='refresh' content='0;URL=Segnalazioni.php'>");
  } else {
